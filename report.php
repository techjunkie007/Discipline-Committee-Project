...
<html>
    ...
    <body>
        ...
        <div id="big_wrapper">
            ...
            <button style="text-align:center; margin-left:300px; margin-top:25px; font:20px  calibri;"><h2 onclick="return confirm('Are you sure?');" ><a style="border:none;" href="generate_all_word.php" >Generate document for students with 3 late entries</a></h2></button>
            <br>
            ...
            <form method="post" action="process_report.php">
                Date <input type="date" name="dates" style="margin:0;
    padding:10px;
    padding-left:35px;
