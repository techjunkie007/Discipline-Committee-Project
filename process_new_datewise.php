...
<html>
    ...
    <body>
        <div id="big_wrapper">
             <div><h1 id="head_text">AKGEC LATE ENTRY SYSTEM <span style="position:absolute;" id="logout_button"><a href="logout.php">Logout</a></span></h1>
                        ...
                        if($query_select)
                            {
                                while($query_detail= mysqli_fetch_array($query_select,MYSQLI_ASSOC))
                                    ...
                                    echo '</div>';
                                    echo '<form action="process_register_customdate.php" method="post" id="form2">';
                                    echo '<br><br>';
                                    echo '<input type="submit" value="Register Late Entry" id="button1" />';
                                    echo '</form>';
                                    echo '<form action="datewise_entries.php" method="post" id="form1">';
                                    echo '<br><br>';
