...
<html>
    ...
    <body>
        <div id="big_wrapper">
             <div id="header">
                <div>
                <a id="backLink" href="main.php">Back</a>
                <h1 id="head_text">

                AKGEC LATE ENTRY SYSTEM 
         ...
         <br>
            ...
            <?php
                echo '<div style="float:left;color:white;margin-left:60px;margin-top:10px;">'.
                'You are entering details for the date '.date("d F,Y",strtotime($_SESSION['dates'])).
                '</div>';
            ?>
            ...
            <form method="post" action="process_new_datewise.php" name="myform" id="form_id"  onsubmit="return validateForm()">
